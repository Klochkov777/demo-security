...
public class JwtService {
    ...
    private Long expirationMsAccessToken;
    @Value("${token.expiration.refresh}")
    private Long ExpirationMsRefreshToken;
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        return generateToken(claims, userDetails, expirationMsAccessToken);
    }

    public String generateRefreshToken(UserDetails userDetails) {
        Map<String, Object> claims = new HashMap<>();
        return generateToken(claims, userDetails, ExpirationMsRefreshToken);
    }
